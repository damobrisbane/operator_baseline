...
<sup>1</sup> Not to be confused with \<REG_LOCATION\>/\<DATESTAMP\>/\<NAMETAG\>**-cut** - which is a specific catalog image that results from running the oc_mirror process, as per <sup>2</sup> - out of scope.
